    ...
    <main>
        ...
        <div id="leftMenu" class="sidenav">
            ...
            <?php
                ...
                {
            ?>
                <a href="classteacher.php?id=<?=$row['id']?>&teacherEmail=<?=$email?>"><?=$row['classname']?></a>
            <?php
                }
            ?>
        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12">
                        <div class="card border-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <a class="btn btn-primary btn-sm" onclick="togCreate(<?=$row['id']?>)">EDIT CLASS</a>
                                    <a class="btn btn-primary btn-sm">DELETE CLASS</a>
                                </div>
                            </div>
                        </div>
                    </div>
